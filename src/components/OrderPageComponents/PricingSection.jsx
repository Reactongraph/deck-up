    ...
    <div className="relative pt-[40px] pb-[50px] bg-gradient-to-t from-[#ECF1F6] to-[rgba(236,241,246,0)]">
      <div className="container mx-auto px-4">
        <div className="max-w-[500px]">
          <h2 className="text-[32px] md:text-[45px]  text-paleBlue font-extrabold leading-tight font-inter">
            Pick up your
          </h2>
          <h2 className="text-[32px] md:text-[45px]  text-paleBlue font-extrabold leading-tight font-inter">
            best plan and pricing
          </h2>
          <p className="mt-[16px] md:mt-[24px] text-body text-bodyColor mb-[40px] md:mb-[68px] text-[16px] md:text-[18px] font-inter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 relative z-[9999]">
          ...
          {orderData.map((plan, index) => (
            ...
            >
              <div>
                <h3 className="text-2xl font-semibold text-[#2B3674] mb-2 font-inter">
                  {plan.title}
                </h3>
                <p className="text-[#FF7F5C] mb-6 font-inter">
                  {plan.subtitle}
                </p>
                <div className="text-4xl md:text-5xl font-bold text-[#2B3674] mb-2 font-inter">
                  {plan.price}{" "}
