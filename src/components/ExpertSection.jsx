...
export default function ExpertSection() {
  return (
    <div className="relative mt-[157px] max-w-[760px] m-auto text-center">
      ...
      <p className="mt-4 text-body text-bodyColor px-[60px]">
        <span className="text-[#0078F0]">SlideXpress</span> is trusted by industry leaders world over creating
        presentation decks as the most effective and expressive communication
        tools. It's this ex-McKinsey team that built DeckUp.
      </p>
